...
public class Activity_12_2 {
	public static void main(String[] args) throws InterruptedException {
		...
		//nested Frame0
		WebElement frame0 = driver.findElement(By.cssSelector("[src='/selenium/nested-iframe1']"));        
        ...
        System.out.println("The Color of the button at main frame: " + frame0.getCssValue("color"));
